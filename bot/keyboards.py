...
# Reply-кнопки главного меню (добавляй новые автоматизации сюда)
...
def main_menu_keyboard() -> ReplyKeyboardMarkup:
    rows: list[list[KeyboardButton]] = [
        [KeyboardButton(text=BTN_GENERATE_VIDEO)],
        [KeyboardButton(text=BTN_BRAINSTORM_TOPIC)],
        [KeyboardButton(text=BTN_VOICE_SCRIPT)],
...
def channel_post_type_keyboard() -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            ...
            [KeyboardButton(text=BTN_GENERATE_VIDEO), KeyboardButton(text=BTN_CHANNEL_POST)],
        ],
        resize_keyboard=True,
        is_persistent=True,
    )
